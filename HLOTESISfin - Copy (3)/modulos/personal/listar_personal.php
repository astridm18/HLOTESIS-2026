...
if (isset($_SESSION['usuario_id'])) {
    ...
    if ($usuario_data = $result_foto->fetch_assoc()) {
        ...
        if (!empty($foto_usuario)) {
            $ruta_foto = __DIR__ . "/../../uploads/fotos_personal/" . $foto_usuario;
            if (file_exists($ruta_foto)) {
                $avatar_url = "../../uploads/fotos_personal/" . $foto_usuario;
            }
        }
    }
    $stmt_foto->close();
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <div class="btn-group" role="group">
                                ...
                                <a href="personal_inactivo.php" class="btn btn-outline-danger">
                                        ...
                                        <table id="tablaPersonal" class="display responsive nowrap" style="width:100%">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = $resultado->fetch_assoc()) {
                                                    ...
                                                    if (!empty($row['foto'])) {
                                                        $ruta_foto_abs = __DIR__ . "/../../uploads/fotos_personal/" . $row['foto'];
                                                        $ruta_foto_rel = "../../uploads/fotos_personal/" . $row['foto'];
                                                        if (file_exists($ruta_foto_abs)) {
                                                            $imagenHTML = "<img src='{$ruta_foto_rel}' style='width:50px;height:50px;object-fit:cover;border-radius:50%;border:2px solid #10104c;'>";
                                                        } else {
