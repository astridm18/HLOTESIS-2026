                    ...
                    <ul class="nav nav-secondary">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="forms">
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="../personal/listar_personal.php">
                                            <span class="sub-item">Lista de Personal</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="../personal/registro_personal.php">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="pacientesMenu">
                                <ul class="nav nav-collapse">
                                    <li>
                                        <a href="../personal/listar_pacientes.php">
        ...
        <div class="main-panel">
                                    ...
                                    <div class="quick-actions-scroll scrollbar-outer">
                                        <div class="quick-actions-items">
                                            <div class="row m-0">
                                                ...
                                                <a class="col-6 col-md-4 p-0" href="../personal/listar_personal.php">
                                                    <div class="quick-actions-item">
                                                ...
                                                <a class="col-6 col-md-4 p-0" href="../personal/registro_personal.php">
                                                    <div class="quick-actions-item">
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <iframe src="../ingreso/formulario_ingreso.php" width="100%" height="800"
